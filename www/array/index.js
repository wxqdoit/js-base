...
//数组常用方法
//push:向数组追加元素, 返回值为新数组的长度
var arr3 = [];
let len1 = arr3.push("ha", 'h', 2, 3, 222);
console.log(len1, arr3);//2 [ 'ha', 'ha' ]


//pop:从数组尾部移除一个元素，返回值为移除的元素
var val = arr3.pop();
console.log(val, arr3);//ha [ 'ha' ]

//shift:从头部移除一个元素 返回移除的元素
var _shift = arr3.shift();
console.log(_shift, arr3);//ha [ 'ha' ]

//unshift:从头部插入元素，返回新数组的长度
...
console.log(_splice,_splice1, arr4);
...
console.log(_forEach,arr10);

//reduce/reduceRight 为数组中的所有元素调用指定的回调函数。 回调函数的返回值是累加结果，并在下一次对回调函数的调用中作为参数提供。
